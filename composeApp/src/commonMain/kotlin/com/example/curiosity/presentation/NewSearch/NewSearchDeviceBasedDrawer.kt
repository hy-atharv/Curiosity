...
import com.example.curiosity.core.navigation.NewSearchNavigation
...
fun NewSearchDrawer(
    ...
    val currentNewSearchStartedState = viewModel.currentNewSearchStartedState.collectAsState()
                            ...
                            Row(
                                ...
                                modifier = Modifier.padding(vertical = 10.dp)
                                    .clickable {
                                        ...
                                        if (currentNewSearchStartedState.value && !currentSearchState.value){
                                            ...
                                            viewModel.onViewModelResetState()
